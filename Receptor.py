...
class AM_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "AM_receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM_receiver")
        ...
        self._volume_range = qtgui.Range(0, 20, 0.1, 12, 200)
        ...
        self.uhd_usrp_source_0.set_center_freq(2450e6, 0)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccf(16, firdes.low_pass(1,samp_rate,samp_rate/(2*decim), 2000), 48e3, samp_rate)
